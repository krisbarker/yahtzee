...
"""
This should hold all the scorecard data for any given player
It should potentially manage the number of throws a play hos

There's work that needs to be done here:
    - needs to deal with yahtzee bonus better
    - Potential to put the number checker in here
"""
